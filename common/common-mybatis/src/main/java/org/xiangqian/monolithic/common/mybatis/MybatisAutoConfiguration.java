...
public class MybatisAutoConfiguration {
    ...
    /**
     * 延迟列表 {@link LazyList} 拦截器 Bean
     *
     * @return
     */
    @Bean
    public Interceptor lazyListInterceptor() {
        MybatisPlusInterceptor mybatisPlusInterceptor = new MybatisPlusInterceptor();
        mybatisPlusInterceptor.addInnerInterceptor(new LazyListInterceptor());
        return mybatisPlusInterceptor;
    }

    /**
     * 延迟列表 {@link LazyList} 拦截器
     * <p>
     * {@link MybatisPlusInterceptor} MybatisPlus插件
     * <p>
     * {@link PaginationInnerInterceptor} 自动分页插件
     ...
     * {@link com.baomidou.mybatisplus.core.override.MybatisMapperMethod#execute(org.apache.ibatis.session.SqlSession, Object[])}
     */
    public static class LazyListInterceptor implements InnerInterceptor {

        /**
         * 预加载行数
         */
        public static final int PRELOAD_ROWS = 1;
        ...
        public void beforeQuery(Executor executor, MappedStatement ms, Object parameter, RowBounds rowBounds, ResultHandler resultHandler, BoundSql boundSql) throws SQLException {
            ...
            long offset = 0;
            long rows = 0;
            if (list == null || (offset = list.getCurrent().longValue() - 1) < 0 || (rows = list.getSize().longValue()) <= 0) {
                return;
            }
