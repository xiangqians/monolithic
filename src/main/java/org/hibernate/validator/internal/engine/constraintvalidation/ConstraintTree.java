 ...
 * https://github.com/hibernate/hibernate-validator/blob/6.2/engine/src/main/java/org/hibernate/validator/internal/engine/constraintvalidation/ConstraintTree.java
 *
...
public abstract class ConstraintTree<A extends Annotation> {
    ...
    protected final <V> Optional<ConstraintValidatorContextImpl> validateSingleConstraint(
        ...
        try {
            ...
            if (validator instanceof org.monolithic.validation.ConstraintValidator) {
                isValid = ((org.monolithic.validation.ConstraintValidator) validator).isValid(validatedValue, constraintValidatorContext, valueContext);
            } else {
