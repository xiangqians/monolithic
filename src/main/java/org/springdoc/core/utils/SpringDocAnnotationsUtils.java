...
/**
 * v2.0.4
 * https://github.com/springdoc/springdoc-openapi/blob/v2.0.4/springdoc-openapi-starter-common/src/main/java/org/springdoc/core/utils/SpringDocAnnotationsUtils.java
 * <p>
 * The type Spring doc annotations utils.
 *
 * @author bnasslahsen
 * @author xiangqian revised in 21:57 2023/05/06
 */
    ...
    public static Schema extractSchema(Components components, Type returnType, JsonView jsonView, Annotation[] annotations) {
        ...
        if (resolvedSchema != null) {
            ...
            if (!CollectionUtils.isEmpty(schemaMap) && components != null) {
                ...
                // extend schema map
                try {
                    schemaMap = SchemaExtension.extend(returnType, schemaMap);
                } catch (Exception e) {
